...
function story(choice){
    ...
    if(choice == "go into the ocean for a nice swim"){
        if(possessions.include("necklace") || possessions.include("bracelet")){
            ...
            if(possessions.include("necklace")){
            ...
            }else if(possessions.include("bracelet")){
        ...
        result += "the necklace<br />the tirara<br />the bracelet";
    ...
    }else if(choice == "the tirara"){
        possessions.push("tirara");
...
function displayChoice(choice) {
    console.log("does this work, display choice");
    document.getElementById("textarea").innerHTML += "<br />" + choice + "<br />";
    story(choice);
}

//displays the result of the choice
function displayResult(result) {
    console.log("does display result work");
